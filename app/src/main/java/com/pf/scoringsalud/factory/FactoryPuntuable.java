        ...
        switch(n){
            case "HOMBRO":
                ...
                p = new Actividad(codigo,"Estiramiento de HOMBRO",1,"Hombro",
                        ...
                        " cambiando el celular de mano, mirando hacia abajo y apuntando a su derecha.",false,2,medibles);
                break;
            ...
            case "CADERA":
                ...
                p = new Actividad(codigo,"Estiramiento de CADERA",1,"CADERA",
                        "ejer_cadera","Pulsar comenzar y dejar el celular apoyado sobre la mesa boca abajo." +
                        ...
                        " flexores de la pierna atrasada.",false,2,medibles);
                break;
                ...
                case "CUELLO":
                    ...
                    p = new Actividad(codigo,"Estiramiento de CUELLO",1,"CUELLO",
                            "ejer_cuello","Pulsar comenzar y poner el celular en la oreja derecha, como para hablar con alguien" +
                            ". Doblar el cuello para el lado que tenga el celular. Al sentir la vibracion, cambiar el telefono de oreja y repetir",false,2,medibles);
                    break;
            case "MUNIECA":
                ...
                p = new Actividad(codigo,"Estiramiento de MUÑECAS",1,"MUÑECAS",
                        "ejer_muniecas","Sostener el Celular de forma horizontal mirando hacia abajo" +
                        ...
                        " para repetir los mismos movimientos",false,2,medibles);
                break;
            case "RODILLA":
                ...
                p = new Actividad(codigo,"Estiramiento de RODILLA",1,"RODILLA",
                        "ejer_rodillas","Pulsar comenzar y dejar el celular apoyado sobre la mesa boca abajo." +
                        "Tendra 3 segundos para ponerse en posicion y sera indicado con un sonido y vibracion." +
                        "Debera estar parado y flxionar la rodilla hacia atras, sugentando el pie con la mano. Al escuchar el " +
                        "sonido y la vibracion, debera cambiar de pierna",false,2,medibles);
                break;
            default:
                p=null;
                break;
